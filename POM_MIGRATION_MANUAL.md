# POM Voting Migration - Manuelle Anwendung

## Problem
Die POM-Tabellen existieren nicht in der Datenbank, daher funktioniert das Voting nicht.

## Lösung
Führen Sie diese SQL-Befehle in Ihrem Supabase Dashboard aus:
...
- ✅ 3 neue Tabellen: `pom_votes`, `pom_results`, `pom_player_standings`
- ✅ Indizes für bessere Performance
- ✅ Funktionen für automatische Berechnungen
- ✅ Trigger für automatische Updates
- ✅ RLS-Policies für Sicherheit

### 4. Test
Starten Sie die App neu und testen Sie das POM Voting!

## Alternative: Supabase CLI
Falls Sie Supabase CLI verwenden möchten:
...
## Support
Bei Problemen schauen Sie in die Konsole der App - die Debug-Logs zeigen, ob die Tabellen korrekt erstellt wurden.
